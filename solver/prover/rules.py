...
class SOLInstantiateRule(InferenceRule):
    ...
    def match_and_instantiate(
        ...
        from solver.sol.ast_ext import ForallPred, ExistsPred, PredicateVariable
        from solver.sol.substitutions_ext import ho_pattern_unify, substitute_predicate
        from solver.sol.kb_ext import instantiate_induction
        from solver.prover.clausifier import to_cnf
