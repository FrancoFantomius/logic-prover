...
from solver.core.ast import Formula, Variable, Term, Not, Equality, Forall
from solver.core.sorts import Ind
from solver.core.substitutions import unify_formulas, UnificationError
...
class TheoremProver:
    ...
    def prove(
        ...
        # Clausify Premises
        from solver.sol.ast_ext import ForallPred, ExistsPred, ForallFunc, ExistsFunc
        from solver.sol.kb_ext import get_sol_axioms
